...
@media screen and (max-width: 599px){#dashboard .mat-table{border:0;vertical-align:middle}#dashboard mat-header-row{display:none!important}#dashboard .mat-table caption{font-size:1em}#dashboard .mat-table .mat-row{border-bottom:5px solid #ddd;display:block!important}#dashboard .mat-table .mat-cell{border-bottom:1px solid #ddd;display:block;font-size:1em;font-weight:700;height:auto;height:initial;margin-bottom:2%;display:flex;padding:0 5px;max-width:100%!important}#dashboard .mat-table .mat-cell:before{content:attr(data-label);float:left;text-transform:uppercase;font-weight:400;font-size:.85em;width:40%;padding:0 5px}#dashboard .mat-table .mat-cell:last-child{border-bottom:0}#dashboard .MB-cell-width{width:60%;text-align:right}#dashboard .cellValueCenter{place-content:initial}#dashboard mat-row:after,#dashboard mat-header-row:after,#dashboard mat-footer-row:after{content:none!important}}#dashboard .widget{padding:12px}#dashboard .widget-front{display:flex;flex-direction:column;flex:1 1 auto;position:relative;overflow:hidden;visibility:visible;width:100%;opacity:1;z-index:10;border-radius:8px!important;transition:transform .5s ease-out 0s,visibility 0s ease-in .2s,opacity 0s ease-in .2s;transform:rotateY(0);-webkit-backface-visibility:hidden;backface-visibility:hidden;border:1px solid #efefef!important}#dashboard .widget-back{display:block;position:absolute;inset:12px;overflow:hidden;visibility:hidden;opacity:0;z-index:10;border-radius:8px;transition:transform .5s ease-out 0s,visibility 0s ease-in .2s,opacity 0s ease-in .2s;transform:rotateY(180deg);-webkit-backface-visibility:hidden;backface-visibility:hidden;border:1px solid}#dashboard .widget-back [fuseWidgetToggle]{position:absolute;top:0;right:0}#dashboard .desk_info{font-size:16px;font-weight:500;color:#0000008a}#dashboard .total_box{border-top:1px solid #efefef!important;padding:16px!important}#dashboard .total_box>span{display:block;overflow:hidden;text-overflow:ellipsis;padding-right:8px;white-space:nowrap;color:#000;font-weight:500}#dashboard .total_box>span.num{font-size:16px;font-weight:700}#dashboard .count_box{padding-bottom:32px!important;padding-top:8px}#dashboard .monthcount{font-size:72px;line-height:72px}#dashboard .monthcount:hover{cursor:pointer}#dashboard .h-52{height:52px!important;min-height:52px!important;max-height:52px!important}#dashboard .light-blue-fg{color:#03a9f4!important}#dashboard .red-fg{color:#f44336!important}#dashboard .orange-fg{color:#ff9800!important}#dashboard .blue-grey-fg{color:#607d8b!important}#dashboard .d_titel{font-size:20px;padding:0 15px;font-weight:600}#dashboard .pgn{background:none!important;padding:0 8px!important;margin:0 0 15px!important}#dashboard .p-t-b-r-l-0-20{padding:0 20px}#dashboard .p-t-b-r-l-0-10{padding:0 10px}#dashboard .edit_icon{margin-right:5px;font-size:17px;vertical-align:bottom}#dashboard .divider-header{padding:10px 20px;color:#039be5;font-weight:bolder;letter-spacing:normal;font-size:15px;background:#f7f7f7;border-radius:8px 8px 0 0}#dashboard .compny_content{flex:0 1 auto;min-height:56px;border-radius:10px;margin:0}#dashboard .compny_content .heading-lable{letter-spacing:normal;color:#1e2129;font-weight:bolder;font-size:14px}#dashboard .compny_content .heading-value{line-height:1.67!important;color:#707276;font-size:14px}#dashboard .card-companyinfo{border:0px solid rgba(0,0,0,.12)!important;margin-bottom:0;border-radius:8px!important}#dashboard .wid_none{background:none!important;border:none!important;border-radius:0!important}#dashboard .mat-tab-body-wrapper{border:0px solid #efefef!important}#dashboard .mat-tab-nav-bar,#dashboard .mat-tab-header{border-bottom:0px solid #efefef!important}#dashboard .sub_header{font-weight:500!important;color:#444!important;padding:7px 20px 7px 15px!important;margin:13px 0!important;line-height:25px;background:#ffffff;border-radius:2px 20px 20px 2px;border-left:5px solid #006ed0;box-shadow:0 0 5px #0000000b!important;font-size:16px!important;width:auto;display:inline-block}#dashboard .ptblr-15-5{padding:15px 5px!important}#dashboard .form_sub_titel1{font-size:1.725rem;font-weight:500!important;color:#2d3748!important;padding:0 0 5px 15px!important;margin:4px 0!important;width:100%}#dashboard .lab_set{padding:5px 3px 5px 15px!important}#dashboard .u_name{padding-top:0}#dashboard .u_name>.frt_lst_name{font-size:16px!important;color:#3f4254!important;font-weight:600!important;outline:0px!important;text-decoration:none}#dashboard .u_name>.e_p_txt{font-size:14px!important;color:#b5b5c3!important;text-decoration:none}#dashboard .p-3{padding:.75rem!important}#dashboard .com_info{margin:5px 20px;border-left:1px solid #f0f0f0;padding-left:20px;display:flex}#dashboard .com_info>div{display:inline;margin-right:25px;border-right:0px solid #f0f0f0;padding-right:25px}#dashboard .com_info>div>p{padding:0;font-size:14px;font-weight:500;margin:0!important}#dashboard .com_info>div>p>span{display:block;width:100%;font-size:13px;font-weight:400}#dashboard .com_info_right>div{display:inline;padding:23px 45px}#dashboard .com_info_right>div>p{padding:0;font-size:18px;font-weight:500;margin:0!important}#dashboard .com_info_right>div>p>span{display:block;width:100%;font-size:16px;font-weight:400}#dashboard .scac_box{background:#2196f3;color:#fff;border-radius:0 .42rem .42rem 0px}#dashboard .dot_box{background:#349ff4;color:#fff;border-radius:0 .42rem .42rem 0px}#dashboard .usertype_box{background:#59b0f6;color:#fff}#dashboard .desk_box,#dashboard .desk_widget{padding:0!important}@media screen and (min-width: 600px) and (max-width: 958px){#dashboard .box{margin-bottom:10px}#dashboard .com_info_right>div{padding:18px 15px}#dashboard .com_info_right>div>p{font-size:14px;line-height:16px}#dashboard .com_info_right>div>p>span{margin-top:7px}#dashboard .mob_mt_0{margin-top:0!important}}#dashboard app-spinner{z-index:100000000000000000000000000000;position:absolute;top:42px}@media (max-width: 575.98px){#dashboard .mat-tab-labels{border-radius:23px!important;width:100%}#dashboard .mat-tab-label{width:100%!important}#dashboard .mat-tab-label-active:first-child{border-radius:23px 23px 4px 4px!important}#dashboard .mat-tab-label-active:nth-child(2){border-radius:4px!important}#dashboard .mat-tab-label-active:nth-child(3){border-radius:4px!important}#dashboard .mat-tab-label-active:nth-child(4){border-radius:4px!important}#dashboard .mat-tab-label-active:nth-child(5){border-radius:4px!important}#dashboard .mat-tab-label-active:last-child{border-radius:4px 4px 23px 23px!important}#dashboard .widget{padding:5px}#dashboard .u_name{padding:5px 10px!important;width:50%}#dashboard .u_name>.e_p_txt{word-break:break-all}#dashboard .com_info{margin:0;padding-left:10px;width:50%}#dashboard .com_info>div{margin-right:0!important;padding-right:5px!important}#dashboard .com_info_right>div{padding:10px;width:50%}#dashboard .dot_box{border-radius:0}#dashboard .m_w_100{width:100%!important}#dashboard .d_titel{font-size:15px;padding:0 5px}#dashboard .p-t-b-r-l-0-10{padding:0!important}#dashboard .com_info_right>div>p{font-size:15px}}#dashboard .mat-column-mcName{flex:0 0 18%}#dashboard .mat-column-alExpDate,#dashboard .mat-column-glExpDate,#dashboard .mat-column-cargoExpDate,#dashboard .mat-column-tiExpDate,#dashboard .mat-column-wcExpDate,#dashboard .mat-column-empLiabExpDate,#dashboard .mat-column-contCargoExpDate,#dashboard .mat-column-refTrailerExpDate,#dashboard .mat-column-empDishHonestyExpDate,#dashboard .mat-column-umbExpDate{place-content:center}#dashboard .text-red{color:#c30303bd!important;font-weight:800;font-size:14px}#dashboard .bg_tbl{background-color:#e2e8f0!important}#dashboard .up_coming .mat-header-row{background-color:#fff!important;margin-bottom:5px}#dashboard .cur_no:hover{cursor:default}#dashboard .widget-front-bg{border:none!important;background-image:linear-gradient(35deg,#5b73e8,#44c4fa)}#dashboard .widget-front>.h-52>span{color:#fff}#dashboard .count_box{padding-bottom:30px!important;padding-top:8px}#dashboard .monthcount{color:#fff!important;text-shadow:0px 3px 20px rgba(0,0,0,.2705882353)}#dashboard .total_box{background:#fff;padding:12px 15px!important;line-height:30px;border-top:none!important}#dashboard .go-btn{position:absolute;right:0;bottom:0;background:#046ed0;color:#fff!important;padding:12px 20px 11px!important;border-radius:0 0 8px;box-shadow:0 3px 20px #0000001f;background-image:linear-gradient(35deg,#5b73e8,#046ed0);cursor:pointer}#dashboard .go-btn>.mat-icon{min-height:21px;vertical-align:middle;font-size:18px;font-weight:500!important;max-height:21px;width:21px;min-width:21px;max-width:21px}#dashboard .src_s_r_box{padding:14px 0!important}#dashboard .pol_alr_exp{position:absolute;right:0;top:2px;z-index:1000000000000000000;background:#f7f7f7;color:#fd6767;padding:10px 15px;border-radius:6px;font-weight:500}#dashboard .pol_alr_exp>span{color:#960404}#dashboard .po_al_ep{margin:0 15px}#dashboard ul.p_a_exp{margin:0;padding:10px 0;list-style:none;display:flex;flex-direction:row;flex-wrap:wrap}#dashboard ul.p_a_exp>li{margin:0 30px 0 0;padding:0;display:flex;flex-direction:row;flex-wrap:nowrap;align-items:stretch}#dashboard ul.p_a_exp>li>span.ex_num{background:#6ccac9;padding:15px 20px;font-size:20px;font-weight:600;color:#fff;border-radius:4px 0 0 4px;margin:0}#dashboard ul.p_a_exp>li>span.ex_txt{text-align:center;color:#9d9d9e;font-size:14px;font-weight:500;background:#f9f9f9;padding:15px 25px;border-radius:0 4px 4px 0;display:flex;align-items:center;align-content:center;min-width:160px;justify-content:center}#dashboard .exp_status_01{outline:none;border-radius:2px}#dashboard .exp_status_01>span.ex_num{background:#2f9cd4!important}#dashboard .exp_status_01>.exp_icon{background:#2f9cd4!important}#dashboard .exp_status_02{outline:none}#dashboard .exp_status_02>span.ex_num{background:#ff6c60!important}#dashboard .exp_status_02>.exp_icon{background:#ff6c60!important}#dashboard .exp_status_03{outline:none}#dashboard .exp_status_03>span.ex_num{background:#f8d347!important}#dashboard .exp_status_03>.exp_icon{background:#f8d347!important}#dashboard .exp_status_04{outline:none}#dashboard .exp_status_04>span.ex_num{background:#57c8f2!important}#dashboard .exp_status_04>.exp_icon{background:#57c8f2!important}#dashboard .exp_status_05{outline:none}#dashboard .exp_status_05>span.ex_num{background:#1d2959!important}#dashboard .exp_status_05>.exp_icon{background:#1d2959!important}#dashboard .po_al_ep_1{margin:10px 0}#dashboard ul.p_a_exp1{margin:0;padding:10px 0;list-style:none;display:flex;flex-direction:row;flex-wrap:wrap;position:relative}#dashboard ul.p_a_exp1>li{margin:5px;padding:9px;background:#f9f9f9}#dashboard ul.p_a_exp1>li>span.exp_icon{background:#282765;padding:10px;font-size:20px;font-weight:600;color:#fff;display:flex;justify-content:center;align-items:center;flex-wrap:nowrap;flex-direction:row;align-content:center;width:45px;height:45px;border-radius:6px;margin:10px auto}#dashboard ul.p_a_exp1>li>span.ex_num1{text-align:center;color:#979797;font-size:34px;font-weight:500;padding:0 0 10px;border-radius:0;display:flex;align-items:center;align-content:center;min-width:0;justify-content:center;line-height:29px}#dashboard ul.p_a_exp1>li>span.ex_txt1{text-align:center;color:#444;font-size:14px;font-weight:500;padding:10px 5px;border-radius:0 4px 4px 0;display:flex;align-items:center;align-content:center;min-width:160px;justify-content:center}@media screen and (max-width: 599px){#dashboard .monthcount{font-size:52px;line-height:52px}#dashboard .count_box{padding-bottom:20px!important}#dashboard .total_box{padding:12px 15px!important;line-height:15px!important}#dashboard .go-btn{padding:8px 15px 9px!important}}

    .folded:not(.unfolded) [_nghost-rgn-c194] .nav-link[_ngcontent-rgn-c194]>.nav-link-title[_ngcontent-rgn-c194],
    .folded:not(.unfolded) [_nghost-rgn-c194] .nav-link[_ngcontent-rgn-c194]>.nav-link-badge[_ngcontent-rgn-c194] {
        opacity: 0;
        transition: opacity .2s ease
    }

    .folded:not(.unfolded) [_nghost-rgn-c200] .nav-link[_ngcontent-rgn-c200]>span[_ngcontent-rgn-c200] {
        opacity: 0;
        transition: opacity .2s ease
    }

    .folded:not(.unfolded) .open[_nghost-rgn-c200] .children[_ngcontent-rgn-c200] {
        display: none !important
    }

    [_nghost-rgn-c200] .nav-link[_ngcontent-rgn-c200] .collapsable-arrow[_ngcontent-rgn-c200] {
        transition: transform .3s ease-in-out, opacity .25s ease-in-out .1s;
        transform: rotate(0)
    }

    [_nghost-rgn-c200]>.children[_ngcontent-rgn-c200] {
        overflow: hidden
    }

    .open[_nghost-rgn-c200]>.nav-link[_ngcontent-rgn-c200] .collapsable-arrow[_ngcontent-rgn-c200] {
    ...
    @media screen and (max-width: 599px) {
        #mc-selectionlist .mat-table {
            border: 0;
            vertical-align: middle
        }

        #mc-selectionlist mat-header-row {
            display: none !important
        }

        #mc-selectionlist .mat-table caption {
            font-size: 1em
        }

        #mc-selectionlist .mat-table .mat-row {
            border-bottom: 5px solid #ddd;
            display: block !important
        }

        #mc-selectionlist .mat-table .mat-cell {
        ...
        #mc-selectionlist .mat-table .mat-cell:before {
        ...
        #mc-selectionlist .mat-table .mat-cell:last-child {
            border-bottom: 0
        }

        #mc-selectionlist .MB-cell-width {
            width: 60%;
            text-align: right
        }

        #mc-selectionlist .cellValueCenter {
            place-content: initial
        }

        #mc-selectionlist mat-row:after,
        #mc-selectionlist mat-header-row:after,
        #mc-selectionlist mat-footer-row:after {
            content: none !important
        }
    }

    #mc-selectionlist .mat-column-checkbox {
        flex: 0 0 175px !important
    }

    #mc-selectionlist .mat-column-action {
        flex: 0 0 40% !important;
        text-align: center;
        justify-content: center
    }

    #mc-selectionlist .mat-column-action:before {
        width: 0 !important
    }

    #mc-selectionlist .mat-column-scac {
        flex: 0 0 100px !important
    }

    #mc-selectionlist .mat-column-mcUiiaStatus {
        flex: 0 0 120px !important
    }

    #mc-selectionlist .mat-column-accountNumber {
        flex: 0 0 100px !important
    }

    #mc-selectionlist .mat-column-epForm5c {
        flex: 0 0 135px !important;
        justify-content: center
    }

    #mc-selectionlist .mat-column-nameChange {
        flex: 0 0 100px !important
    }

    #mc-selectionlist .src_btn_box {
        margin-right: 12px !important;
        margin-left: 0 !important
    }

    #mc-selectionlist .mb-5 {
        margin-bottom: 5px !important
    }

    #mc-selectionlist .ac_ic {
        border-radius: 10px !important;
        margin: 5px 3px;
        height: 36px !important;
        width: 36px !important;
        box-shadow: 0 3px 3px -1px #0003, 0 0 5px #00000024, 0 3px 10px #0000001f
    }
    ...
    @media (max-width: 575.98px) {
        ...
        #mc-selectionlist .ac_ic .mat-button-wrapper {
            padding: 0;
        ...
        #mc-selectionlist .ac_ic .mat-button-wrapper .mat-icon {
    ...
    @media screen and (min-width: 600px) and (max-width: 959px) {
        ...
        #mc-selectionlist .mat-row {
            margin-bottom: 10px !important
        }

        #mc-selectionlist mat-row,
        #mc-selectionlist mat-footer-row {
            min-height: 40px;
            width: 49.5%
        }

        #mc-selectionlist .mat-chip-list-wrapper {
            justify-content: flex-end
        }
    ...
    .cdk-high-contrast-active .mat-paginator-icon {
        fill: CanvasText
    }
    ...
    .mat-standard-chip._mat-animation-noopable {
        transition: none !important;
        animation: none !important
    }
    ...
    .cdk-high-contrast-active .mat-standard-chip.mat-chip-selected {
        outline-width: 3px
    }
    ...
    #policy-selectionlist .p-rl-12 {
        padding: 0 12px
    }

    #policy-selectionlist .width-full {
        width: 100%
    }

    #policy-selectionlist .Back-btn,
    #policy-selectionlist .Update-btn {
        margin: 0 10px
    }

    #policy-selectionlist .padding15 {
        padding: 0 15px !important
    }

    #policy-selectionlist .cellValueCenter {
        display: flex;
        place-content: center;
        padding: 0
    }

    #policy-selectionlist .center>.header {
        height: 80px;
        min-height: 80px;
        max-height: 80px
    }

    #policy-selectionlist .center>.header .mat-display-1 {
        font: 400 20px/5px Muli, Helvetica Neue, Arial, sans-serif
    }

    #policy-selectionlist .center>.header .welcome-message {
        margin: 0;
        margin-top: 0 !important;
        margin-bottom: 0 !important
    }

    #policy-selectionlist .center>.header .selected-project {
    ...
    #policy-selectionlist .center>.header .project-selector {
        margin-left: 1px;
        background: rgba(0, 0, 0, .12);
        border-radius: 0 8px 0 0
    }

    #policy-selectionlist .center>.header .project-selector mat-icon {
        color: #fff
    }

    #policy-selectionlist .status-CANCELLED {
        background-color: #1d2959 !important;
        color: #fff !important
    }

    #policy-selectionlist .status-DELETED {
        background-color: red !important;
        color: #fff !important
    }

    #policy-selectionlist .status-ACTIVE {
        background-color: #006400;
        color: #fff !important
    }

    #policy-selectionlist .action-buttion {
        font-size: 13px !important;
        font-weight: 500 !important
    }

    #policy-selectionlist .mr-15 {
        margin-right: 15px
    }

    #policy-selectionlist .mat-raised-button {
        font-size: 12px !important
    }

    #policy-selectionlist .centerDiv {
        display: flex;
        height: 300px;
        justify-content: center;
        align-items: center
    ...
    #policy-selectionlist .left,
    #policy-selectionlist .right {
        padding: 1em;
        text-align: left
    }

    #policy-selectionlist .parent {
        display: flex;
        overflow: hidden;
        margin: 1em 0;
    ...
    #policy-selectionlist .example-radio-group {
        display: flex;
        flex-direction: column;
        margin: 15px 0
    }

    #policy-selectionlist .example-radio-button {
        margin: 5px
    }

    #policy-selectionlist .policies-title {
        font-size: 18px;
        color: #039be5 !important
    }

    #policy-selectionlist .select-type-box {
    ...
    #policy-selectionlist .select-type-box2 {
        border: 1px solid #337ab7;
        margin: 25px 20% 10px !important;
        border-radius: 8px
    }

    #policy-selectionlist .select-type-box2 .policies-header {
        background: #337ab7
    }

    #policy-selectionlist .select-type-box2 .policies-header .policies-title {
        color: #fff !important;
        padding-top: 10px
    }

    #policy-selectionlist .LR-btn {
        margin: 10px
    }

    #policy-selectionlist #parent5>div {
        flex: 1
    }

    #policy-selectionlist .titel_cer {
        width: 100%;
        padding: 0 !important;
        margin: 0 !important;
        line-height: 15px;
    ...
    #policy-selectionlist .cellTableNotes {
        margin: 0 25px;
        color: red;
    ...
    #policy-selectionlist .btn_back_set {
        vertical-align: middle;
        padding: 0 !important;
        line-height: 14px
    }

    #policy-selectionlist .p-l-r-24 {
        padding-left: 24px !important;
        padding-right: 24px !important
    }

    #policy-selectionlist .p-t-b-5 {
        padding-top: 5px !important;
        padding-bottom: 5px !important
    }

    #policy-selectionlist .fnt_b {
        font-weight: 700 !important
    }

    #policy-selectionlist .namechangeAcord {
        font-size: 16px;
        font-weight: 600;
        line-height: 31px;
        min-width: 70px;
    ...
    #policy-selectionlist .sub_title {
        width: 100%;
        width: auto;
    ...
    #policy-selectionlist .tags a {
        ...
        font-weight: 700;
        margin: 5px 16px 8px 15px
    }

    #policy-selectionlist .tags a:before {
        content: "";
        position: absolute;
        top: 0;
        left: -12px;
    ...
    #policy-selectionlist .tags a:after {
        content: "";
        position: absolute;
        top: 10px;
        left: 1px;
    ...
    #policy-selectionlist .tags a.color1 {
        background: #de3f3e
    }

    #policy-selectionlist .tags a.color1:before {
        border-color: transparent #de3f3e transparent transparent
    }

    #policy-selectionlist .mt-15 {
        margin-top: 15px
    }

    #policy-selectionlist .costm_redio {
        margin-bottom: 0
    }

    #policy-selectionlist .showepspecnote {
        width: 100%;
    ...
    @media (max-width: 575.98px) {
        ...
        #policy-selectionlist .mat-radio-label-content {
            font-size: 13px;
            padding-left: 5px
        }
        ...
        #policy-selectionlist .mb-p-motcar {
    ...
    #policy-selectionlist .ml-15 {
        margin-left: 15px !important
    }

    #policy-selectionlist .small_cont {
        width: 60% !important;
        margin: 0 auto
    }

    @media screen and (min-width: 360px) and (max-width: 786px) {
        #policy-selectionlist .small_cont {
            width: 90% !important;
            margin: 0 auto
        }
    ...
    #acordPage .nonUIIAEpFlagCls {
        color: maroon;
        font-weight: 700
    }

    #acordPage .widget-front {
        background: white;
    ...
    #acordPage .acord-button-row {
        padding: 20px 20px 0;
        width: 100%
    }

    #acordPage .acord-button-row button,
    #acordPage .acord-button-row a {
        margin-right: 8px;
        margin-bottom: 5px;
        border-radius: 28px;
    ...
    #acordPage .action-buttion {
        font-size: 13px !important;
        font-weight: 500 !important
    }

    #acordPage .mat-form-field-appearance-outline .mat-form-field-wrapper {
        margin: 0 !important
    }

    #acordPage .mat-form-field-wrapper {
        padding-bottom: 0 !important
    }

    #acordPage .mat-radio-button {
        font-size: 12px
    }

    #acordPage .mat-radio-inner-circle {
        border-radius: 50%;
        box-sizing: border-box;
        height: 18px;
        left: 0;
        position: absolute;
        top: 0;
        transition: transform ease .28s, background-color ease .28s;
        width: 18px
    }

    #acordPage .mat-radio-outer-circle {
        box-sizing: border-box;
        height: 18px;
        left: 0;
        position: absolute;
    ...
    #acordPage .mat-radio-label-content {
    ...
    #acordPage #accord_container {
        min-width: 500px;
        background-color: #fff
    }

    #acordPage .inputTextCls {
        height: 19px;
        font-family: Arial;
        font-size: 9pt;
        width: 100%;
    ...
    #acordPage .outertable {
        border: 1px solid black
    }

    #acordPage .lable_title {
    ...
    #acordPage .lable_title>label {
        margin-right: 5px
    }

    #acordPage .lable_title_normal,
    #acordPage .lable_title_large {
        font-family: Verdana, Geneva, sans-serif;
        font-size: 12px
    }

    #acordPage .lable_title_bold {
        font-family: Verdana, Geneva, sans-serif;
        font-size: 12px;
        font-weight: 700
    }

    #acordPage .borderType1 {
        border-left: 1px solid black;
        border-right: 1px solid black;
        border-bottom: 1px solid black
    }

    #acordPage .highlightedPolicy {
        background-color: #e8edff
    }

    #acordPage .overwrittenPolicy {
        background-color: #f9eaea
    }

    #acordPage table.tftable {
        font-family: Arial;
        font-size: 13px;
        color: #333;
        width: 100%;
    ...
    #acordPage table.tftable>tr {
        background-color: #fff
    }

    #acordPage .tftable>tbody>tr>td,
    #acordPage .tftable>tbody>tr>th {
        border: 1px solid #ccc;
        font-size: 13px;
        padding: 2px
    }

    #acordPage table input[type=text] {
        height: 19px;
        font-family: Verdana, Geneva, sans-serif;
        font-size: 9pt;
        width: 100%
    ...
    #acordPage table input[type=checkbox] {
        margin: 2px;
        height: 20px;
        width: 20px
    }

    #acordPage table.innerTable {
        font-size: 12px;
        color: #333;
        width: 100%
    }

    #acordPage table.innerTable>tr>th {
        font-size: 11px;
        font-family: Arial;
        font-weight: 700;
        background-color: #fff;
    ...
    #acordPage table.innerTable>tr {
        background-color: #fff
    }

    #acordPage table.innerTable>tr>td {
        font-size: 12px;
    ...
    #acordPage .acord_title {
        font-family: Arial;
        font-size: 16pt;
        font-weight: 700
    }

    #acordPage .acord_datetime {
        height: 55px;
        float: right;
        width: 180px;
        border-left: 1px solid black
    ...
    #acordPage .enable_btm_bdr {
        border-bottom: 1px solid black
    }

    #acordPage .acc_calender {
        padding: 3px 8px !important;
        border-radius: 0
    }

    #acordPage .msgDisplay {
        color: red;
        border-color: #3a87ad
    }
    ...
    #acordPage input[type=checkbox] {
        vertical-align: sub
    }

    #acordPage input[type=radio] {
        vertical-align: text-bottom
    }

    #acordPage input[type=text] {
        vertical-align: middle;
        padding: 0 0 2px 3px;
        font-size: 13px !important;
        color: #585858
    ...
    #acordPage .table-ps>tbody>tr>td {
        width: 25%
    }

    #acordPage .last-border {
    ...
    #acordPage .bottom-border {
        border-bottom: 1px solid #448bbf !important
    }

    #acordPage #footer {
        margin-top: 10px;
        border-top: solid 1px #448bbf
    }

    #acordPage .textcenter tr td,
    #acordPage .textcenter tr th {
        text-align: center !important
    }

    #acordPage .textleft tr td,
    #acordPage .textleft tr th {
        text-align: left !important
    }

    #acordPage .textright tr td,
    #acordPage .textright tr th {
    ...
    #acordPage .left-arrow {
        width: 45px;
        height: 41px;
        line-height: 39px
    }

    #acordPage .left-arrow a {
        padding: 0 0 0 19px;
        display: block;
        margin: 0
    }

    #acordPage .right-arrow {
        width: 44px;
        height: 41px;
        line-height: 39px
    }

    #acordPage .right-arrow a {
        padding: 0 0 0 19px;
        display: block;
        margin: 0
    }
    ...
    #acordPage body.fixed>.header,
    #acordPage body.fixed .navbar {
        position: fixed
    }
    ...
    #acordPage body.fixed .wrapper {
        margin-top: 125px
    }

    #acordPage body>.header {
        position: absolute;
        top: 0;
        left: 0;
        right: 0;
    ...
    #acordPage body>.header .navbar .sidebar-toggle {
        float: left;
    ...
    #acordPage body>.header .navbar .sidebar-toggle:hover .icon-bar {
        background: #f6f6f6
    }

    #acordPage body>.header .navbar .sidebar-toggle .icon-bar {
        display: block;
        width: 22px;
        height: 2px;
        border-radius: 4px
    ...
    #acordPage body>.header .navbar .sidebar-toggle .icon-bar+.icon-bar {
        margin-top: 4px
    }

    #acordPage body>.header .navbar .nav>li.user>a {
        font-weight: 700
    }
    ...
    #acordPage #nav ul li:last-child {
        border: none
    }

    #acordPage #nav ul li a {
        color: #fff;
        padding: 3px 0 0;
        margin: 0
    }

    #acordPage .right-side,
    #acordPage .left-side {
        min-height: 100%;
        display: block
    }
    ...
    #acordPage .page-header {
        margin: 10px 0 20px;
        font-size: 22px
    }

    #acordPage .page-header>small {
        color: #666;
        display: block;
        margin-top: 5px
    }

    #acordPage .sort-highlight {
        background: #f4f4f4;
        border: 1px dashed #ddd;
        margin-bottom: 10px
    }

    #acordPage .skin-blue .navbar .sidebar-toggle .icon-bar {
    ...
    #acordPage .navbar-right li {
        border-right: 1px solid #fff !important;
        float: right !important;
        margin-top: -1px
    }

    #acordPage .navbar-right li:first-child {
        border: 0px !important
    }

    #acordPage .no-right-border {
    ...
    #acordPage .content-main-bg {
        background: #fff;
        overflow: hidden
    }

    #acordPage .content-main-bg .left-bar h1 a {
        font-weight: 400;
        text-align: center;
        font-size: 27px;
        color: #fff;
    ...
    #acordPage .content-main-bg .left-bar ul {
        margin: 0;
        padding: 0;
        clear: both
    }

    #acordPage .breadcrumb {
        background: #fff;
        line-height: 30px;
        margin: 10px 0 15px;
        border-radius: 0;
    ...
    #acordPage .row.space-right {
        padding: 0 10px
    }

    #acordPage .left-blog h1 {
    ...
    #acordPage .left-blog ul {
        padding: 20px 0 9px 6px;
        margin: 0
    }

    #acordPage .left-blog ul li {
        list-style-type: none;
        margin: 0;
        font-size: 16px;
        color: #fff;
    ...
    #acordPage .right-blog ul {
        margin: 0;
        padding: 21px 0 9px 6px
    }

    #acordPage .right-blog ul li {
        list-style-type: none;
        padding-bottom: 4px
    }

    #acordPage .right-blog ul li a {
        color: #fff
    }

    #acordPage .view-all-main {
        background: #fff;
        border: solid 1px #448bbf;
        padding: 0 0 0 10px;
        line-height: 28px;
        margin: 5px 0 0;
        font-size: 12px
    ...
    #acordPage .view-all-main a {
        color: #448bbf;
        text-decoration: underline
    }

    #acordPage .table-main {
        border: #448bbf solid 1px;
        background: #fff;
        padding: 15px 15px 0;
        overflow: hidden
    }

    #acordPage .title-right-inner1 {
        line-height: 40px;
        background: #ddd;
        font-size: 16px;
        color: #448bbf;
    ...
    #acordPage .panel-group .panel {
        border-radius: 0;
        margin-bottom: 15px
    }

    #acordPage .table1-inner {
        margin: 0;
        overflow: hidden
    }

    #acordPage .table1-inner ul {
        margin: 0;
        padding: 0;
        clear: both;
        overflow: hidden;
    ...
    #acordPage .table1-inner ul li:nth-child(2) {
        border-left: solid 2px #ddd
    }

    #acordPage .table1-inner ul li a {
        color: #448bbf
    }

    #acordPage .display-table table tr th:last-child {
        border: none
    }

    #acordPage .display-table table tr {
        border-bottom: solid 1px #ddd
    }

    #acordPage .display-table table tr td {
        text-align: left;
        font-size: 11px;
        color: #585858;
        font-family: Verdana, Geneva, sans-serif;
    ...
    #acordPage .display-table table tr td a {
        color: #448bbf
    }
    ...
    #acordPage #footer ul li {
        list-style-type: none;
        border-right: solid 1px #448bbf;
        display: inline;
        padding: 0 15px;
        font-family: Verdana, Geneva, sans-serif;
        font-size: 14px
    ...
    #acordPage #footer ul li a {
        color: #448bbf
    }

    #acordPage #footer ul li:last-child {
        border: none
    }

    #acordPage .search-left h3 {
        font-size: 14px;
        color: #fff;
        font-family: Verdana, Geneva, sans-serif;
        margin-top: 10px
    ...
    #acordPage .search-left {
        clear: both;
        overflow: hidden
    }

    #acordPage .logo-login {
        padding: 60px 0 35px
    }
    ...
    #acordPage .input-box input::-webkit-input-placeholder {
        color: #fff
    }

    #acordPage .input-box input:-moz-placeholder {
        color: #fff
    }
    ...
    #acordPage .input-box input:-ms-input-placeholder {
        color: #fff
    }

    #acordPage .remember-forgot {
        font-family: open_sansregular;
        overflow: hidden
    }
    ...
    #acordPage .submit-input {
        padding-bottom: 18px
    }

    #acordPage .member-yet {
        line-height: 22px;
        font-family: Roboto Regular;
        font-size: 12px;
        color: #fff;
    ...
    #acordPage .table-ps>thead>tr>th,
    #acordPage .table-ps>tbody>tr>th,
    #acordPage .table-ps>tfoot>tr>th,
    #acordPage .table-ps>thead>tr>td,
    #acordPage .table-ps>tbody>tr>td,
    #acordPage .table-ps>tfoot>tr>td {
        padding: 5px;
    ...
    #acordPage font.error {
        font-size: 11px;
        color: #c00
    }

    #acordPage font.error1 {
        font-size: 11px;
        color: #fff
    }

    #acordPage .siteLogin-title {
        color: #fff;
        font-family: open_sansregular;
        font-size: 31px;
        font-weight: 700;
    ...
    #acordPage .siteLoginText input {
        background: none repeat scroll 0 0 #0e74bc;
        border: 1px solid #fff;
        color: #fff;
        font-family: open_sansregular;
        font-size: 12px;
    ...
    #acordPage .columnleftalignsmart {
        width: auto;
        height: auto;
        text-align: left;
        vertical-align: middle;
    ...
    #acordPage .columnleftalignsmartbold {
        width: auto;
        height: auto;
        text-align: left;
        vertical-align: middle;
    ...
    #acordPage .columnrightalignbold {
        width: auto;
        height: auto;
        text-align: left;
        vertical-align: middle;
    ...
    #acordPage .columnleftalignactionbold {
        width: auto;
        height: auto;
        text-align: left !important;
        vertical-align: middle !important;
    ...
    #acordPage .columnleftalignboldmsg {
        width: auto;
        height: auto;
        text-align: left;
        vertical-align: middle;
    ...
    #acordPage .columncenteraligninvalid {
        width: auto;
        height: auto;
        text-align: center;
        vertical-align: middle;
    ...
    #acordPage .columncenteralignaction {
        width: auto;
        height: auto;
        text-align: center !important;
        vertical-align: middle !important;
    ...
    #acordPage .columnleftalignaction {
        width: auto;
        height: auto;
        text-align: left;
        vertical-align: middle;
    ...
    #acordPage .columncenteralignPendingWritten {
        width: auto;
        height: auto;
        text-align: center;
        vertical-align: middle;
    ...
    #acordPage .columncenteralignNonUiiaMC {
        width: auto;
        height: auto;
        text-align: center;
        vertical-align: middle;
    ...
    #acordPage .columncenteralignOverWritten {
        width: auto;
        height: auto;
        text-align: center;
        vertical-align: middle;
    ...
    #acordPage .columncenteralignPolDel {
        width: auto;
        height: auto;
        text-align: center;
        vertical-align: middle;
    ...
    #acordPage .columncenteralignbold {
        width: auto;
        height: auto;
        text-align: center !important;
        vertical-align: middle !important;
    ...
    #acordPage .just-infor ul {
        padding: 0;
        margin: 4px 0 9px
    }

    #acordPage .just-infor ul li {
        list-style-type: none;
        padding: 0 0 2px 5px;
        font-size: 12px
    }

    #acordPage div.normal {
    ...
    #acordPage .changeSelectStyle select {
        width: 90px
    }
    ...
    #acordPage .error-msg p {
        font-size: 15px !important;
        color: red !important
    }

    #acordPage .error-msg ul {
        padding: 0;
        margin: 0
    }

    #acordPage .error-msg ul li {
        font-size: 15px !important;
        color: red !important;
        list-style-type: none
    }

    #acordPage .error-container {
        background: #fff;
        margin: 20% auto 21%;
        padding: 30px;
        float: none;
    ...
    #acordPage .success-msg {
        margin: 0
    }

    #acordPage .success-msg h1 {
        font-size: 25px;
        font-weight: 700;
        color: #007906
    }

    #acordPage .success-msg p {
        font-size: 15px;
        color: #007906
    }
    ...
    #acordPage .highlightedPolicyActive {
        background-color: #f9eaea
    }

    #acordPage .makeRowDisabled {
        pointer-events: none
    }

    #acordPage table.agencyllc {
        font-family: Arial, Helvetica, sans-serif;
    ...
    #acordPage table.agencyllc td,
    #acordPage table.agencyllc th {
        border: 1px solid #dde2e5;
        padding: 4px 2px
    }

    #acordPage table.agencyllc tbody td {
        font-size: 12px
    }

    #acordPage table.agencyllc thead {
        background: #f3f7fa;
        background: linear-gradient(to bottom, #f6f9fb 0%, #f4f7fa 66%, #f3f7fa 100%)
    }

    #acordPage table.agencyllc thead th {
        font-size: 12px;
        font-weight: 700;
        color: #000
    }

    #acordPage table.agenc_sub_table>tbody>tr>th,
    #acordPage table.agenc_sub_table>tbody>tr>td {
        border-right: 1px solid #bbb;
        border-bottom: 1px solid #bbb;
        padding: 4px !important
    }

    #acordPage table.agenc_sub_table>tbody>tr>th:first-child,
    #acordPage table.agenc_sub_table>tbody>tr>td:first-child {
        border-left: none
    }

    #acordPage table.agenc_sub_table>tbody>tr>th:last-child,
    #acordPage table.agenc_sub_table>tbody>tr>td:last-child {
        border-right: none
    }

    #acordPage table.a_s_t_b tr:last-child>th,
    #acordPage table.a_s_t_b tr:last-child>td {
        border-bottom: none !important
    }

    #acordPage .date_lable {
        padding-left: 1px;
        font-size: 12px;
        font-weight: 700;
        padding-bottom: 1px
    ...
    #acordPage .table100 th,
    #acordPage .table100 td {
        border-left: 1px solid #dee2e6;
        padding: 7px 10px !important;
        border-bottom: 1px dashed rgba(222, 226, 230, .768627451)
    }
    ...
    #acordPage .table100 th:nth-child(even) {
        background: #e8edff;
    ...
    #acordPage .addl_ep_selected {
        background-color: #dce3fd !important
    }

    #acordPage .addl_ep_selected>td {
        border-bottom: 1px dashed #dee2e6 !important
    }

    #acordPage .bg_c_equ,
    #acordPage .bg_c_label {
        background: #b9c9fe !important
    }

    #acordPage .bg_c_c_label {
    ...
    #acordPage .tr_active {
        ...
        border: 2px solid #a3b5f3 !important
    }

    #acordPage .text-center {
        text-align: center !important
    }

    #acordPage .mat-checkbox {
        font-size: 12px !important;
        background: #fff !important;
        font-weight: 700;
        line-height: 12px
    ...
    #acordPage .textboxWithchb {
        display: flex;
        place-items: center
    }

    #acordPage .chkb_lable_title {
        font-family: Verdana, Geneva, sans-serif;
        font-size: 12px;
        font-weight: 700;
        background-color: #fff;
    ...
    #acordPage .close_btn {
        background: #f03c57 !important
    }

    #acordPage .edit_btn {
        background: #374858 !important
    }

    #acordPage .sub_btn {
        background: #253586 !important
    }

    #acordPage .view_btn {
        background: #ccb02d !important
    }

    #acordPage .copy_btn {
        background: #c956b5 !important
    }

    #acordPage .tab_fild_set {
        min-width: 150px !important;
        max-width: 150px !important
    }

    #acordPage .lable_ep_set {
        display: block
    }

    #acordPage .poly_notes {
        font-family: Arial;
        font-size: 7pt;
        margin: 2px
    }

    #acordPage .color_notes {
        width: 25px;
        display: inline-block
    }
    ...
    #acordPage .mat-form-field-prefix {
        top: .004em !important
    }
    ...
    #acordPage .titel_bg>.mat-checkbox {
        margin-right: 3px;
    ...
    #acordPage .mat-slide-toggle {
        display: block
    }

    #acordPage .theme-options-button {
        position: absolute;
        top: 60px;
        right: 0;
        width: 42px;
    ...
    #acordPage .theme-options-button.side-panel-hidden {
        right: 0 !important
    }

    #acordPage .theme-options-button mat-icon {
        animation: rotating 3s linear infinite
    }

    #acordPage .theme-options-button:hover {
        opacity: 1
    }

    #acordPage .theme-options-sidebar {
        width: 360px;
        min-width: 360px;
        max-width: 360px
    }

    #acordPage .mebtn>.mat-button-wrapper {
        transform: scale(1);
        width: 47px;
        margin-left: 16px;
        text-align: center;
    ...
    #acordPage .mebtn:hover {
        width: 230px !important
    }

    #acordPage .mebtn:hover>.mat-button-wrapper {
        margin-left: 10px
    }

    #acordPage .mebtn>.mat-button-wrapper>.mat-icon {
        margin-right: 6px;
        font-size: 23px
    }

    #acordPage .mar_drewer {
        position: fixed;
        right: 24px;
        top: 215px
    }
    ...
    #acordPage .mat-flat-button.mat-accent,
    #acordPage .mat-raised-button.mat-accent,
    #acordPage .mat-fab.mat-accent,
    #acordPage .mat-mini-fab.mat-accent,
    #acordPage .mat-slide-toggle.mat-checked .mat-slide-toggle-thumb {
        background-color: #006ed0 !important
    }

    #acordPage .mat-slide-toggle.mat-checked .mat-slide-toggle-bar {
        background-color: #006ed070
    }

    #acordPage .mat-checkbox-disabled {
        cursor: default;
        opacity: 1
    }

    #acordPage .mat-checkbox-disabled .mat-checkbox-inner-container {
        background: #f3f3f3 !important
    }

    #acordPage .mat-form-field-appearance-outline .mat-form-field-suffix {
        top: .25em;
        right: -8px
    }
    ...
    #acordPage .copy_pol_box {
        margin: 10px 24px !important;
        display: block !important
    }

    #acordPage .copy_pol_box>.title {
        font-size: 15px;
        font-weight: 700;
    ...
    #acordPage .copy_pol_box>.copy_notes {
        width: auto;
        font-size: 12px;
        font-weight: 700;
        color: red;
    ...
    #acordPage .copy_pol_box>.cp_ply_cbx {
        display: flex;
    ...
    #acordPage app-copy-inplace-policy {
        display: flex;
        overflow: hidden
    }

    #acordPage app-copy-inplace-policy .theme-options-panel {
        display: flex;
        flex-direction: column;
        flex: 1 0 auto;
    ...
    #acordPage app-copy-inplace-policy .theme-options-panel .header {
        display: flex;
        flex: 0 1 auto;
        margin-bottom: 5px;
        align-items: center;
    ...
    #acordPage app-copy-inplace-policy .theme-options-panel .header .title {
        font-size: 20px;
        font-weight: 600;
        padding-left: 4px
    }

    #acordPage app-copy-inplace-policy .theme-options-panel form {
        display: flex;
        flex: 1 1 auto;
        flex-direction: column
    }

    #acordPage app-copy-inplace-policy .theme-options-panel form .group {
        display: flex;
        flex: 1 0 auto;
        flex-direction: column;
        position: relative;
    ...
    #acordPage app-copy-inplace-policy .theme-options-panel form .group h2 {
        position: absolute;
        top: -11px;
        left: 8px;
        margin: 0;
    ...
    #acordPage app-copy-inplace-policy .theme-options-panel form .group h3 {
        font-size: 14px;
        font-weight: 600;
        margin: 24px 0 16px;
        padding: 0
    ...
    #acordPage app-copy-inplace-policy .theme-options-panel form .group h3:first-of-type {
        margin-top: 0
    }

    #acordPage .mat-drawer.mat-drawer-end {
        z-index: 1000
    }
    ...
    #acordPage .copy-inplace-policy .header_pol {
        display: flex;
        flex: 0 1 auto;
        margin-bottom: 5px;
        align-items: center;
    ...
    #acordPage .header_pol .title {
        font-size: 20px;
        font-weight: 600;
        padding-left: 4px
    }

    #acordPage .copy_notes {
        width: 300px;
        font-size: 12px;
        font-weight: 700;
        color: red
    ...
    #acordPage .group_ply .mat-checkbox {
        padding: 6px 0
    }

    #acordPage .mat-checkbox1 {
    ...
    #acordPage .lable_title>label>.mat-checkbox-inner-container {
        margin-right: 5px;
        margin-left: 5px
    }

    #acordPage .mat-form-field {
        min-height: 22px
    }

    #acordPage .mat-form-field-appearance-outline .mat-form-field-flex {
        padding: 7px .75em 0;
        margin-top: -7px;
        position: relative
    }
    ...
    #acordPage .mat-form-field {
        font: 400 11px/22px Muli, Helvetica Neue, Arial, sans-serif
    }

    #acordPage .mat-form-field-appearance-outline .mat-form-field-infix {
        padding: 0 !important;
        border-top: 0 !important
    }

    #acordPage .mat-form-field-appearance-outline .mat-form-field-outline {
        height: 22px !important;
        top: 0
    }

    #acordPage input.mat-input-element {
        margin-top: 0
    }

    #acordPage .mat-form-field-suffix .mat-icon-button {
        height: auto
    }
    ...
    #acordPage .drop_box {
        ...
        margin: 0 0 5px;
        max-width: 100%;
        font: 600 13px/22px Muli, Helvetica Neue, Arial, sans-serif;
        padding: 0 .75em;
        position: relative;
        text-align: inherit;
        background: #fff !important;
    ...
    #acordPage .teaxt_area .mat-form-field-flex .mat-form-field-outline {
        height: 35px !important
    }

    #acordPage .teaxt_area textarea {
        border: none !important;
        background: none !important;
        width: 100%
    }
    ...
    #acordPage .mat-form-field {
        font: 400 11px/22px Muli, Helvetica Neue, Arial, sans-serif !important
    }

    #acordPage .mat-checkbox-layout .mat-checkbox-label {
        line-height: 21px;
        font-size: 12px;
        color: #000000de;
        font-weight: 600
    ...
    #acordPage .mat-wb .mat-checkbox-label {
        font-weight: 500 !important
    }
    ...
    #acordPage .add_new_ep {
        width: 100%;
        margin: 0;
        padding: 0
    }

    #acordPage .add_new_title {
        font-size: 20px;
        font-weight: 600;
        margin: 0 0 0 20px
    }

    #acordPage .lst_new_add {
        margin: 0;
        list-style: none
    }

    #acordPage .lst_new_add>li {
        display: inline-block;
        font-size: 15px;
        padding: 14px 12px;
        font-weight: 700
    ...
    #acordPage .lst_new_add>li>.mat-icon {
        color: #149414;
        vertical-align: bottom
    }
    ...
    #acordPage .closebtn:hover>.mat-icon {
    ...
    #acordPage .mat-form-field-infix {
        border-top: .00275em solid transparent !important
    }

    #acordPage .mat-form-field-appearance-legacy .mat-form-field-underline {
        bottom: 1.15em
    }

    #acordPage .mat-form-field-appearance-legacy .mat-form-field-infix {
        padding: .7175em 0 .9175em
    }

    .mat-autocomplete-panel .op_text {
    ...
    .ep_list_notes {
        background: rgba(4, 110, 208, .1607843137);
        padding: 10px !important;
        border-left: 5px solid #046ed0;
        margin-top: 10px;
        margin-bottom: 10px;
        font-weight: 700
    }
    ...
    .acordUploadMandatoryCheckbox .mat-checkbox-frame {
    ...
    mat-form-field.border-red .mat-form-field-outline {
        color: #2196f3 !important
    }

    mat-form-field.border-red .mat-form-field-outline-thick {
        opacity: 1
    }

    mat-form-field.border-red .mat-input-element {
        color: #2196f3 !important
    }

    mat-form-field.border-red .mat-form-field-label {
        color: #2196f3 !important
    }

    mat-form-field.border-red .pv_cls {
        position: absolute;
        box-sizing: border-box;
        width: 100%;
        overflow: hidden;
