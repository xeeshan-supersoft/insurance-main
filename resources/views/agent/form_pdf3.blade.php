                                ...
                                <tr class="ng-tns-c268-42">
                                  <td colspan="7" style="padding: 10px;" class="ng-tns-c268-42">
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0"
                                      ...
                                      <tbody class="ng-tns-c268-42">
                                        <tr class="ng-tns-c268-42">
                                          <td  valign="middle" formgroupname="autoDetForm"
                                            class="age_checkbox ng-tns-c268-42 ng-untouched ng-pristine ng-invalid">
                                            <mat-checkbox formcontrolname="stdEndorse"
                                              class="mat-checkbox ng-tns-c268-42 mat-accent ng-untouched ng-pristine ng-valid"
                                              id="mat-checkbox-16"><label class="mat-checkbox-layout"
                                                for="mat-checkbox-16-input"><span
                                                  class="mat-checkbox-inner-container mat-checkbox-inner-container-no-side-margin">
                                                  <input
                                                    type="checkbox" class="mat-checkbox-input cdk-visually-hidden"
                                                    id="mat-checkbox-16-input" tabindex="0" aria-checked="false" /><span
                                                    matripple=""
                                                    ...
                                                    class="mat-checkbox-background"><svg version="1.1" focusable="false"
                                          ...
                                          <td class="ng-tns-c268-42">
                                            <div class="age_text ng-tns-c268-42">
                                              ...
                                              Endorsement (Form
                                              <a href="javascript:void(0);" class="ng-tns-c268-42">UIIE-1</a>
                                              or <a href="javascript:void(0);" class="ng-tns-c268-42">CA
                                                23-17</a>
                                        ...
                                        <tr class="ng-tns-c268-42">
                                          <td  valign="middle" class="age_checkbox ng-tns-c268-42">
                                            <mat-checkbox formcontrolname="gltiFlag"
                                              class="mat-checkbox ng-tns-c268-42 mat-accent ng-untouched ng-pristine ng-valid"
                                              id="mat-checkbox-17"><label class="mat-checkbox-layout"
                                                for="mat-checkbox-17-input"><span
                                                  class="mat-checkbox-inner-container mat-checkbox-inner-container-no-side-margin">
                                                  <input
                                                    type="checkbox" class="mat-checkbox-input cdk-visually-hidden"
                                                    id="mat-checkbox-17-input" tabindex="0" aria-checked="false" /><span
                                                    matripple=""
                                                    class="mat-ripple mat-checkbox-ripple mat-focus-indicator"><span
                                                      class="mat-ripple-element mat-checkbox-persistent-ripple"></span></span><span
                                                    class="mat-checkbox-frame"></span><span
