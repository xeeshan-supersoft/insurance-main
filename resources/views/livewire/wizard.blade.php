                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group p-3">
                        <label for="description">
                            Insurance Agency License Numbe</label>
    ...
    <div class="row setup-content {{ $currentStep != 5 ? 'displayNone' : '' }}" id="step-5">
        <div class="col-xs-12">
            <div class="row justify-content-center" style="height: 80vh">
                <h4 style="font-weight: 600;  " class="text-center"> Accept the terms & conditions of the UIIA
                ...
                <div class="px-3">
                    <div class="form-check mb-5 pb-5 ">
                        ...
                        <label class="form-check-label" for="defaultCheck2">
                            I accept the terms and conditions of the UIIA and submit the following signature page as
