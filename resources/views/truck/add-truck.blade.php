...
<script>
  ...
  $('#add').click(function(){
           i++;
           $('#dynamic_field').append('<div class="row"><div class=col-4><div class="form-floating form-floating-outline mb-3"><input name=vehicle_registration_number[] placeholder="Enter Vehicle Registration Number" class=form-control><label for=username1>Vehicle Registration Number</label></div></div><div class=col-4><div class="form-floating form-floating-outline mb-3"><input name=vehicle_make[] placeholder="Enter Vehicle Make" class=form-control><label for=email1>Vehicle Make</label></div></div><div class=col-4><div class="form-floating form-floating-outline mb-3"><input name=vehicle_model[] placeholder="Enter Vehicle Model" class=form-control><label for=email1>Vehicle Model</label></div></div><div class=col-4><div class="form-floating form-floating-outline mb-3"><input name=vehicle_year[] placeholder="Enter Vehicle Year" class=form-control><label for=email1>Vehicle Year</label></div></div><div class=col-4><div class="form-floating form-floating-outline mb-3"><input name=vehicle_capacity[] placeholder="Enter Vehicle Capacity" class=form-control><label for=email1>Vehicle Capacity</label></div></div><div class=col-4><div class="form-floating form-floating-outline mb-3"><input name=vehicle_status[] placeholder="Enter Vehicle Status" class=form-control><label for=email1>Vehicle Status</label></div></div><div class=col-4><div class="form-floating form-floating-outline mb-3"><input name=mc_number[] placeholder="Enter Motor Carrier Number" class=form-control><label for=email1>Motor Carrier Number</label></div></div></div>');
      });
